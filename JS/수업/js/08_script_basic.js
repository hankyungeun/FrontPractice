...
function question2() {
   ...
   */
    let eleArea1 = document.getElementById("area1");
    eleArea1.innerHTML = "오늘 <span style='color:red;'>" + value + " </span>를 먹었습니다.";
}
